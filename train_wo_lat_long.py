...
class FlightTimeSeriesDataset(Dataset):
    def __init__(self, instance_dict, window_size=30, stride=1, phase_col='Phase', stat_path='./stats_wo_lat_long.npz'):
        """
        Args:
...
save_path = 'best_flight_phase_lstm_30history_wo_longlat.pth'
